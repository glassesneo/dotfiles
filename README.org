...
- Coding agents entry guidance: =AGENTS.md=
- Module tree guidance: =modules/AGENTS.md=
- Config-specific notes: =modules/config/AGENTS.md=
- Toplevel/secrets notes: =modules/toplevel/AGENTS.md=
