...
local function today_command()
  ...
  local daily_yesterday = journal .. "/daily/" .. yesterday_date .. ".org"
  local monthly_yesterday = journal .. "/" .. os.date("%Y-%m", yesterday_time) .. ".org"
  local today_path = journal .. "/daily/" .. today_date .. ".org"
  ...
  -- Create directory
  local ok_mkdir, mkdir_err = pcall(vim.fn.mkdir, journal .. "/daily", "p")
