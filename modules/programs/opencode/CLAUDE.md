...
- `scout` handles source-read-only planning/read/report command workflows such as `/spec`, `/sensei`, `/idea`, `/review`, and `/primary-review`; it must not modify source, configuration, tests, or lockfiles.
