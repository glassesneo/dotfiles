...
- Interpret the design, implementation report, or diff from alternate reasonable angles when that changes review judgment.
...
5. Alternate interpretations: design/context readings that affect findings, or `none`.
