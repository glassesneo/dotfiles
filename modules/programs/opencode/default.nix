    ...
    programs.opencode = {
      ...
      rules =
        ...
        + ''
          ...
          - Use `idea` when the user has a rough concept/problem feeling and needs help clarifying intent before planning.
          - After `idea` crystallizes the problem, switch to `spec` in the same chat history for formal specification and planning.
