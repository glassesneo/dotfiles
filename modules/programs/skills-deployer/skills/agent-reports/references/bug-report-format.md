...
Use this template after reproducing or investigating a defect. Keep the summary
short enough that an implementation agent can choose a fix path before reading
