...
3. Obtain explicit approval before creating the specification artifact through
   the mapped specification-author capability.
...
3. Obtain explicit approval before creating the plan artifact through the
   mapped implementation-planner capability.
4. Report the artifact and readiness, then offer confirm, bounded revision, or
...
3. If planning is selected, identify exact coverage and present a candidate
   plan.
4. Obtain a separate explicit approval before creating the complete or
   bounded-partial plan through the mapped implementation-planner capability.
...
3. Create the plan through the mapped implementation-planner capability. If the
   resulting plan materially differs from the approved candidate, stop before
   implementation and reconfirm with the user.
4. Run implementation through the mapped source-changing implementer with the
   approved plan and governing context.
